                        ...
                        <div class="bg-light rounded h-100 p-4">
                            <div class="in-brand-management" style="background-color: white; padding: 15px; border-radius: 20px;">
                                ...
                                <form id="add-form" method="post" action="manager">
                                    ...
                                    <input style="width: 70%;" name="product_id" type="text" class="form-control validate" required value="${listPro.product_id}" readonly/>

                                    <label style="color: black;" for="name">Name Of Food</label>
                                    <input style="width: 70%;" id="name" name="product_name" type="text" class="form-control validate" required value="${listPro.product_name}"/>

                                    <label style="color: black;" for="quantity">Quantity</label>
                                    <input style="width: 70%;" id="quantity" name="product_quantity" type="number" class="form-control validate" required value="${listPro.product_quantity}" />

                                    <label style="color: black;" for="id">Price</label>
                                    <input style="width: 70%;" id="price" name="product_price" type="text" class="form-control validate" required value="${listPro.product_price}" />

                                    <label style="color: black;" for="id">Discount</label>
                                    <input style="width: 70%;" id="discount" name="discount" type="number" class="form-control validate" required value="${listPro.discount}" />

                                    <label style="color: black;" for="description">Description</label>
                                    <textarea style="width: 70%;" class="form-control validate" name="product_description" rows="3" required>${listPro.product_description}</textarea>
                                    ...
                                    <select name="category_id" style="width: 70%; font-size: 15px; border-color: #c4c4c4;">
                                        <c:forEach var="category" items="${listCategory}">
                                            <c:choose>
                                                <c:when test="${category.category_id == listPro.category_id}">
                                    ...
                                    <select name="status" style="width: 70%; font-size: 15px; border-color: #c4c4c4;">
                                        <c:choose>
                                            <c:when test="${listPro.status == true}">
                                    ...
                                    <div class="col-12" style="margin-top: 10px;">
                                        <button type="submit" name="btnEditProduct" class="btn btn-primary btn-block text-uppercase">Done</button>
                                    </div>
                                </form> 
                            </div>
                        </div>
