...
<html>
    <head>
        ...
        <!--    Document Title-->
        <!-- ===============================================-->
        <title>OMF | Order & Management Of Food</title>

        <!-- ===============================================-->
        <!--    Favicons-->
        <!-- ===============================================-->
        <link rel="apple-touch-icon" sizes="180x180" href="/OMF/UI/public/assets/img/favicons/apple-touch-icon.png">
        <link rel="icon" type="image/png" sizes="32x32" href="/OMF/UI/public/assets/img/favicons/favicon-32x32.png">
        <link rel="icon" type="image/png" sizes="16x16" href="/OMF/UI/public/assets/img/favicons/favicon-16x16.png">
        <link rel="shortcut icon" type="image/x-icon" href="/OMF/UI/public/assets/img/favicons/favicon.ico">
        <link rel="manifest" href="/OMF/UI/public/assets/img/favicons/manifest.json">
        <meta name="msapplication-TileImage" content="/OMF/UI/public/assets/img/favicons/mstile-150x150.png">
        <meta name="theme-color" content="#ffffff">

        <!-- ===============================================-->
        <!--    Stylesheets-->
        <!-- ===============================================-->
        <link href="/OMF/UI/public/assets/css/theme.css" rel="stylesheet" />
    ...
    <body>
        ...
        System.out.println("test"+products.get(1).getProName());
        ...
        <main class="main" id="top">
            <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top" data-navbar-on-scroll="data-navbar-on-scroll">
                <div class="container"><a class="navbar-brand d-inline-flex" href="Home.jsp"><img class="d-inline-block" src="/OMF/UI/public/assets/img/gallery/logo.svg" alt="logo" /><span class="text-1000 fs-3 fw-bold ms-2 text-gradient">OMFood</span></a>
            ...
            <section class="py-5 overflow-hidden bg-primary" id="home">
                <div class="container">
                    <div class="row flex-center">
                        <div class="col-md-5 col-lg-6 order-0 order-md-1 mt-8 mt-md-0"><a class="img-landing-banner" href="#!"><img class="img-fluid" src="/OMF/UI/public/assets/img/gallery/hero-header.png" alt="hero-header" /></a></div>
                        ...
                        <div class="col-xl-9">
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-md-3 mb-6">
                                    <div class="text-center"><img class="shadow-icon" src="/OMF/UI/public/assets/img/gallery/location.png" height="112" alt="..." />
                                        <h5 class="mt-4 fw-bold">Select location</h5>
                                        <p class="mb-md-0">Choose the location where your food will be delivered.</p>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-3 mb-6">
                                    <div class="text-center"><img class="shadow-icon" src="/OMF/UI/public/assets/img/gallery/order.png" height="112" alt="..." />
                                        <h5 class="mt-4 fw-bold">Choose order</h5>
                                        <p class="mb-md-0">Check over hundreds of menus to pick your favorite food</p>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-3 mb-6">
                                    <div class="text-center"><img class="shadow-icon" src="/OMF/UI/public/assets/img/gallery/pay.png" height="112" alt="..." />
                                        <h5 class="mt-4 fw-bold">Pay advanced</h5>
                                        <p class="mb-md-0">It's quick, safe, and simple. Select several methods of payment</p>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-3 mb-6">
                                    <div class="text-center"><img class="shadow-icon" src="/OMF/UI/public/assets/img/gallery/meals.png" height="112" alt="..." />
                                            ...
                                            <div class="col-sm-6 col-md-4 col-xl mb-5 h-100">
                                                <div class="card card-span h-100 rounded-3"><img class="img-fluid rounded-3 h-100" src="assets/img/gallery/cheese-burger.png" alt="..." />
                                                    <div class="card-body ps-0">
                                                        <h5 class="fw-bold text-1000 text-truncate mb-1">${product.proName}</h5>
            ...
            <section>
                ...
                <div class="container">
                            ...
                            <div class="card card-span shadow-warning" style="border-radius: 35px;">
                                <div class="card-body py-5">
                                    <div class="row justify-content-evenly">
                                        <div class="col-md-3">
                                            <div class="d-flex d-md-block d-xl-flex justify-content-evenly justify-content-lg-between"><img src="/OMF/UI/public/assets/img/icons/discounts.png" width="100" alt="..." />
                                        ...
                                        <div class="col-md-3 hr-vertical">
                                            <div class="d-flex d-md-block d-xl-flex justify-content-evenly justify-content-lg-between"><img src="/OMF/UI/public/assets/img/icons/live-tracking.png" width="100" alt="..." />
                                                <div class="d-flex d-lg-block d-xl-flex flex-center">
                                        ...
                                        <div class="col-md-3 hr-vertical">
                                            <div class="d-flex d-md-block d-xl-flex justify-content-evenly justify-content-lg-between"><img src="/OMF/UI/public/assets/img/icons/quick-delivery.png" width="100" alt="..." />
                                                <div class="d-flex d-lg-block d-xl-flex flex-center">
                    ...
                    <div class="row flex-center mt-md-8" style="margin-bottom: 10px;">
                    </div>
                </div>
            </section>
            ...
            <section class="py-0">
                <div class="bg-holder" style="background-image:url(/OMF/UI/public/assets/img/gallery/cta-two-bg.png);background-position:center;background-size:cover;">
                </div>
                <!--/.bg-holder-->
                    ...
                    <div class="row justify-content-lg-between">
                        ...
                        <div class="col-6 col-md-4 col-lg-auto mb-3">
                            <ul class="list-unstyled mb-md-4 mb-lg-0">
                                ...
                                <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Thành phố Hồ Chí Minh</a></li>
                                <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Đà Nẵng</a></li>
                                <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Hải Phòng</a></li>
                                <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Cần Thơ</a></li>
                            </ul>
                        </div>
                        <div class="col-6 col-md-4 col-lg-auto mb-3">
                            <ul class="list-unstyled mb-md-4 mb-lg-0">
                                <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Biên Hòa</a></li>
                                <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Nha Trang</a></li>
                                <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Huế</a></li>
                                <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Quy Nhơn</a></li>
                                <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Vũng Tàu</a></li>
                            </ul>
                        </div>
                        <div class="col-6 col-md-4 col-lg-auto mb-3">
                            <ul class="list-unstyled mb-md-4 mb-lg-0">
                                <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Đà Lạt</a></li>
                                <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Thanh Hóa</a></li>
                                <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Hạ Long</a></li>
                                <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Vinh</a></li>
                                <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Phan Thiết</a></li>
                            </ul>
                        </div>
                        <div class="col-6 col-md-4 col-lg-auto mb-3">
                            <ul class="list-unstyled mb-md-4 mb-lg-0">
                                <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Bắc Ninh</a></li>
                                <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Hải Dương</a></li>
                                <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Nam Định</a></li>
                                <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Buôn Ma Thuột</a></li>
                                <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Thái Nguyên</a></li>
                            </ul>
                        </div>
                        <div class="col-6 col-md-4 col-lg-auto mb-3">
                            <ul class="list-unstyled mb-md-4 mb-lg-0">
                                <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Bà Rịa</a></li>
                                <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Bảo Lộc</a></li>
                                <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Mỹ Tho</a></li>
                                <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Long Xuyên</a></li>
                                <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Tuy Hòa</a></li>
                            </ul>
                        </div>
                    </div>
                    <hr class="text-900" />
                    <div class="row">
                        ...
                        <div class="col-12 col-md-8 col-lg-6 col-xxl-4">
                            ...
                            <div class="text-start my-3"> <a href="#!">
                                    <svg class="svg-inline--fa fa-instagram fa-w-14 fs-2 me-2" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="instagram" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width="20.15px" height="23.0375px">
                                    ...
                                    <svg class="svg-inline--fa fa-facebook fa-w-16 fs-2 mx-2" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="facebook" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="20.15px" height="23.0375px">
                                    ...
                                    <svg class="svg-inline--fa fa-twitter fa-w-16 fs-2 mx-2" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="twitter" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="20.15px" height="23.0375px">
                    ...
                    <div class="row flex-center pb-3">
                        ...
                        <div class="col-md-6 order-1">
                            <p class="text-200 text-center text-md-end"> Made with&nbsp;
                                ...
                                </svg>&nbsp;by&nbsp;<a class="text-200 fw-bold" href="https://themewagon.com/" target="_blank">Group 5 </a>
                            </p>
                        </div>
                    </div>
                </div><!-- end of .container-->
